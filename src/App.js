    ...
    <div className="App">
      <main id ="content">
        ...
        <p>“Help Us Keep the Castro Queer A.F.!” reads the GoFundMe page used to crowdsource donations to fund Queer Arts Featured. As rent prices have skyrocketed across San Francisco, the boutique gallery space for local LGBTQ artists has relied heavily on community funding to stay open. Operating in the storefront where Harvey Milk’s camera shop once stood, the gallery hopes to honor his legacy by creating safe spaces where queer people can express themselves freely.</p>
         ...
         <p>Sid Deshpande, a ceramics sculptor, is grateful to have spaces like Queer AF to feature their work. As a POC non-binary artist, Deshpande has found gaining access to gallery space much more challenging for those who do not fit the cis-white-male standard. </p>
         ...
         <p>“What's interesting is that you have vacancies but you still have sky high rents,” USF Professor Rachel Brahinsky said. “And sometimes those things are connected, right, because… if we're talking about commercial rents, businesses get kicked out essentially by rent hikes. And then sometimes business owners will hold the place vacant for a while, rather than reduce the rent, right? They'll just sit on it and wait.” </p>
         <p>Brahinsky, a professor in the Urban Studies department at the University of San Francisco, specializes in human and social geography within American cities, with a longtime focus on San Francisco. According to Brahinsky, gentrification in the Castro area is nothing new. But, the area has remained predominantly made up of white gay men because they are the ones able to afford the increasing price of living. </p>
         <p>“As gay men start establishing households, you have two or more men in a household in our society where men still get paid more than women for the same jobs… so you'd have higher income households, essentially,” said Brahinsky. “And so the Castro starts concentrating this community that can handle the kind of rising gentrification of San Francisco more broadly. So it remains gay, but becomes increasingly more white, gay male, right, in terms of who's owning houses and living there.”</p>
         <LeafMap/>
         
         <p>Shand, too, has observed the changes in the neighborhood due to the rising price of living. “As [the Castro] becomes more homogenized by the tech industry and this digital way of connecting, the people who create the culture who are on the ground, putting the work in, can no longer afford to do that in San Francisco,” says Shand. </p>
         ...
         <p>While 22-year-old Doris Mantley has not been around the Castro long enough to see it change, she believes digital connection has benefited the LGBTQ community. 
      ...
      <p>“We need safe spaces but the goal is to not have to have safe spaces” says Cullen. </p>
        <p>While older generations may cling to the idea of having spaces in designated queer neighborhoods, Gen Z has hope to be able to redefine what a safe space really is. </p>
